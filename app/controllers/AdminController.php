                ...
                if ($file['error'] === UPLOAD_ERR_OK && $file['size'] <= $maxSize) {
                    ...
                    if (in_array($mime, $allowed)) {
                        ...
                        $dest = $uploadsDir . '/' . $filename;
                            ...
                            $imagen_url = asset('view/public/uploads/' . $filename);
                            if ($previous_image && strpos($previous_image, url('view/public/uploads/')) === 0) {
                                $prevPath = __DIR__ . '/../' . str_replace(url(''), '', $previous_image);
